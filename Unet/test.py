...
if __name__ == '__main__':
    ...
    save_path = "CamVid/predict9/V2"

    dp = data.data_preprocess(test_path=test_path,save_path=save_path,flag_multi_class=True,num_classes=12)

    #load model
    model = load_model('D:/wxn/Unet/model9/model9/CamVid_model_v2.hdf5')
